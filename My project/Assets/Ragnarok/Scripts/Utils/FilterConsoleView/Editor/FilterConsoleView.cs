...
namespace Ragnarok
{
    public class FilterConsoleView : EditorWindow, IHasCustomMenu
    {
        ...
        private LogItem selectedLog;

        //[MenuItem("Window/General/Filter Console")]
        private static void OpenWindow()
        {
            FilterConsoleView window = GetWindow<FilterConsoleView>();
        ...
        private void DrawMenuBar()
        {
            ...
            GUILayout.Button(new GUIContent("Clear"), EditorStyles.toolbarButton, GUILayout.ExpandWidth(false));
            GUILayout.Space(5);

            collapse = GUILayout.Toggle(collapse, new GUIContent("Collapse"), EditorStyles.toolbarButton, GUILayout.ExpandWidth(false));
            clearOnPlay = GUILayout.Toggle(clearOnPlay, new GUIContent("Clear On Play"), EditorStyles.toolbarButton, GUILayout.ExpandWidth(false));
            errorPause = GUILayout.Toggle(errorPause, new GUIContent("Error Pause"), EditorStyles.toolbarButton, GUILayout.ExpandWidth(false));
        ...
        {
            LogItem l = new LogItem(false, condition, stackTrace, type);
            logs.Add(l);
        }
        ...
        public void AddItemsToMenu(GenericMenu menu)
        {
            ...
            {
                menu.AddItem(Style.OpenPlayerLog, false, InternalEditorUtility.OpenPlayerConsole);
            }
            
            menu.AddItem(Style.OpenEditorLog, false, InternalEditorUtility.OpenEditorConsole);
        }

        private class Style
        {
            public static readonly GUIContent OpenPlayerLog = new GUIContent("Open Player Log");
            public static readonly GUIContent OpenEditorLog = new GUIContent("Open Editor Log");
        }

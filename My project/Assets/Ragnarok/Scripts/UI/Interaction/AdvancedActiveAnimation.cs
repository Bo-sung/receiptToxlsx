...
namespace Ragnarok
{
	/// <summary>
	/// ActiveAnimation 참조
	/// Play 할 때마다 강제로 mNotify 활성화
	/// <see cref="ActiveAnimation"/>
	/// </summary>
	public class AdvancedActiveAnimation : MonoBehaviour
    {
		/// <summary>
		/// Active animation that resulted in the event notification.
		/// </summary>

		static public AdvancedActiveAnimation current;
		...
		static public AdvancedActiveAnimation Play(Animation anim, string clipName, Direction playDirection,
			EnableCondition enableBeforePlay, DisableCondition disableCondition)
		{
			...
			AdvancedActiveAnimation aaa = anim.GetComponent<AdvancedActiveAnimation>();
			if (aaa == null) aaa = anim.gameObject.AddComponent<AdvancedActiveAnimation>();
			aaa.mAnim = anim;
			aaa.mDisableDirection = (Direction)(int)disableCondition;
			aaa.onFinished.Clear();
			aaa.Play(clipName, playDirection);

			if (aaa.mAnim != null) aaa.mAnim.Sample();
			else if (aaa.mAnimator != null) aaa.mAnimator.Update(0f);
			return aaa;
		}
		...
		static public AdvancedActiveAnimation Play(Animation anim, Direction playDirection)
		{
		...
		static public AdvancedActiveAnimation Play(Animator anim, string clipName, Direction playDirection,
			EnableCondition enableBeforePlay, DisableCondition disableCondition)
		{

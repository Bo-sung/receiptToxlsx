...
namespace Ragnarok
{
    public class UIBookOnBuffView : MonoBehaviour, IUIBookView
    {
        ...
        private BookOnBuffViewPresenter presenter;

        public void OnInit()
        {
            presenter = new BookOnBuffViewPresenter(this);
        }
        ...
        {
            listPanel.SetSideTabInfo(new UIBookListPanel.TabInfo(LocalizeKey._40235.ToText(), CostumeType.Pet)); // 펫

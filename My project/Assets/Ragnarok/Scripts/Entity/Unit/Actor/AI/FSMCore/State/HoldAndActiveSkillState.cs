...
{
    public class HoldAndActiveSkillState : UnitFsmState
    {
        ...
        public HoldAndActiveSkillState(UnitActor actor, StateID id) : base(actor, id)
        {
        }
        ...
        public override void Update()
        {
            ...
            {
                // 범위 내 가능한 타겟 리스트 추출
                var availableTargets = GetValidTargets();

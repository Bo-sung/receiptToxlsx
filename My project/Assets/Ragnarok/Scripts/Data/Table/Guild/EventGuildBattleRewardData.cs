namespace Ragnarok
{
    public sealed class EventGuildBattleRewardData : GuildBattleRewardData
    {
        private readonly int start;

        public EventGuildBattleRewardData(int start, int end, RewardData reward1, RewardData reward2, RewardData reward3)
